...
})(exports.ROUTER_MODE || (exports.ROUTER_MODE = {}));
...
var history = function history(mode, opts) {
  ...
  switch (mode) {
    case exports.ROUTER_MODE.HISTORY:
      return createBrowserHistory(opts);

    case exports.ROUTER_MODE.HASH:
    default:
...
var Router = /*#__PURE__*/function () {
  ...
  function Router(opts) {
    ...
    opts = opts || {};
    opts.historyOpts = {};
    opts.mode = opts.mode || exports.ROUTER_MODE.HISTORY;

    if (tc__default["default"].not.isEnumKey(opts.mode, exports.ROUTER_MODE)) {
    ...
    if (opts.mode == exports.ROUTER_MODE.HASH) {
      opts.historyOpts.hashType = opts.hashType || exports.HASH_TYPE.SLASH;

      if (tc__default["default"].not.isEnumKey(opts.historyOpts.hashType, exports.HASH_TYPE)) {
